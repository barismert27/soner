  ...
  try {
    ...
    await dbRun(`
      CREATE TABLE IF NOT EXISTS jobs (
        ...
        tooth_shape TEXT,
        tooth_color TEXT,
        selected_teeth TEXT, -- FDI Notasyon numaraları (örn: "11,12,21")
        treatment_types TEXT, -- İşlem türleri (örn: JSON veya virgüllü metin)
    ...
    console.error = console.error; // Keep log clear
